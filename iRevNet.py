...
class iRevNet(nn.Module):
    def __init__(self, nBlocks, nStrides, nClasses, nChannels=None, init_ds=0,
        ...
        self.conv1 = nn.Conv2d(2*nChannels[0], 2*nChannels[0], 3, 1, 1)
        self.conv2 = nn.Conv2d(2*nChannels[0], in_shape[0], 3, 1, 1)
